...
def preprocess_data():
    try:
        ...
        input_file = os.path.join(parent_dir, 'Goal6.csv')
        output_file = os.path.join(current_dir, 'Goal6_processed.csv')
        ...
        print("Reading Goal6.csv...")
        df = pd.read_csv(input_file, sep=';', on_bad_lines='skip')
        
        # Check required columns
        required_columns = ['Indicator', 'SeriesCode', 'SeriesDescription', 'GeoAreaName', 'TimePeriod', 'Value', 'Source', 'Level/Status', 'Location', 'Activity']
