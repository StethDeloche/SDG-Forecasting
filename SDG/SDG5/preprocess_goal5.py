...
def preprocess_data():
    try:
        ...
        input_file = os.path.join(parent_dir, 'Goal5.csv')
        output_file = os.path.join(current_dir, 'Goal5_processed.csv')
        ...
        print("Reading Goal5.csv...")
        df = pd.read_csv(input_file, sep=';', on_bad_lines='skip')
        
        # Check required columns
        required_columns = ['Indicator', 'SeriesCode', 'SeriesDescription', 'GeoAreaName', 'TimePeriod', 'Value', 'Source', 'Sex', 'Age', 'Location']
